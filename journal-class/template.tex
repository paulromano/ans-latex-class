...
\abstractText{Use 8.5x11 paper size, with 1" margins on all sides.  A required
  200-250 word abstract starts on this line.  Leave two blank lines before
  ``ABSTRACT'' and one after.  Use 10 point Times New Roman here and single
...
\keywordsText{List of at most five key words}
...
\bibliographystyle{../bibtex-style/ans}
